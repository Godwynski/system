    ...
    if (!finalCard) {
      return (
        <div className="flex min-h-[60vh] flex-col items-center justify-center p-6 text-center">
          ...
          <h2 className="text-xl font-bold text-foreground">Finalizing Setup...</h2>
          <p className="text-muted-foreground mt-2 max-w-xs">
            We&apos;re still setting up your secure identity. Please refresh this page in a few seconds.
          </p>
          <a 
            href="/protected/my-card"
            className="mt-6 inline-block rounded-xl bg-primary px-6 py-2 font-semibold text-primary-foreground transition-colors hover:bg-primary/90"
          >
            Refresh Now
          </a>
        </div>
