      ...
      <div className="hidden md:flex md:w-1/2 relative flex-col justify-between p-10 overflow-hidden bg-black/40">
        ...
        <div className="relative z-10 flex flex-col gap-6">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed max-w-xs">
            A next-generation library management platform built for students, librarians, and administrators alike.
          </p>

          <div className="flex flex-col gap-3 mt-4">
            {[
              { label: "Smart Catalog", desc: "AI-powered book discovery" },
              { label: "Role-Based Access", desc: "Tailored for every user type" },
              { label: "Automated Fines", desc: "Zero manual tracking needed" },
            ].map((f) => (
