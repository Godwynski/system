...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center bg-zinc-50 text-zinc-900 font-sans selection:bg-indigo-500/30">
      <div className="flex-1 w-full flex flex-col items-center">
        {/* Navigation Bar */}
        <nav className="w-full flex justify-center border-b border-zinc-200 h-16 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        ...
        <div className="flex-1 flex flex-col gap-12 max-w-5xl p-5 mt-16 w-full relative z-10">
          ...
          <main className="flex-1 flex flex-col gap-8 px-4 py-8 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-3 p-6 rounded-2xl border border-zinc-200 bg-white hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-500/5 transition-all duration-300">
              ...
              <div className="flex flex-col gap-3 p-6 rounded-2xl border border-zinc-200 bg-white hover:border-purple-200 hover:shadow-lg hover:shadow-purple-500/5 transition-all duration-300">
              ...
              <div className="flex flex-col gap-3 p-6 rounded-2xl border border-zinc-200 bg-white hover:border-pink-200 hover:shadow-lg hover:shadow-pink-500/5 transition-all duration-300">
        ...
        {/* Footer */}
        <footer className="w-full flex items-center justify-center border-t border-zinc-200 mx-auto text-center text-sm gap-8 py-12 mt-12 bg-white text-zinc-500">
          <p>
