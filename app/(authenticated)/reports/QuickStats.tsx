...
export async function QuickStats() {
  ...
  const stats = [
    { label: "Active Loans", value: activeLoans.count ?? 0, icon: ClipboardList, color: "bg-indigo-500/10 text-indigo-500", href: "/history" },
    { label: "Overdue", value: overdueLoans.count ?? 0, icon: Activity, color: "bg-rose-500/10 text-rose-500", href: "/history" },
    { label: "Circulation", value: "Live", icon: TrendingUp, color: "bg-emerald-500/10 text-emerald-500", href: "/history" },
    { label: "Pending", value: pendingCards.count ?? 0, icon: BookCheck, color: "bg-amber-500/10 text-amber-500", href: "/admin/approvals" },
    { label: "Suspended", value: suspendedCards.count ?? 0, icon: Activity, color: "bg-muted text-muted-foreground", href: "/admin/approvals" },
  ];
