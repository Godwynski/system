...
export const DEFAULT_POLICIES = {
  loan_period_days: { value: "14", description: "Default loan period in days" },
  ...
  max_reservations_per_student: { value: "3", description: "Maximum active reservations a student can hold" },
