...
export function Hero({ user, role }: { user: User | null; role: string | null }) {
  return (
    <div className="flex flex-col gap-8 items-center justify-center p-8 lg:p-12 bg-white border border-zinc-200 rounded-[32px] shadow-sm relative overflow-hidden">
      ...
      <div className="text-center z-10 flex flex-col gap-4">
        {user ? (
          ...
          <>
            ...
            <p className="text-zinc-600 max-w-xl mx-auto text-base md:text-lg leading-relaxed">
              A premium, light-mode focused library system. Seamlessly connecting Admins, Librarians, Staff, and Students in one unified platform.
            </p>
          </>
        )}
      </div>
