          ...
          <div className="flex flex-col gap-6 items-center w-full">
            ...
            <div className="w-full space-y-4 mt-2">
              ...
              <div className="grid grid-cols-2 gap-3 w-full">
                {[
                  { label: "Admin", email: "admin@lumina.test", icon: ShieldCheck, color: "hover:border-emerald-500/50 hover:bg-emerald-500/[0.04] hover:text-emerald-500 dark:hover:text-emerald-400" },
